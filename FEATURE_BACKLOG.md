...
- **Backup restore flow** (TODO.md "Later") — explicit T13b/future follow-on; T13a provides validateBackup as groundwork (schema-version checking, lossless round-trip validation), but applying decoded backup data back into ModelContext is out of scope (restore/import-validation path to be designed in T13b or later).
